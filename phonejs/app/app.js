...
$(function() {
    ...
    KitchenSink.app.router.register("", { view: "Home" });
    KitchenSink.app.router.register("categories/:id", { view: "Categories", id: undefined  });
    KitchenSink.app.router.register("search/", { view: "Search" });
});
